...
private ["_group","_city","_area","_players","_cities","_pos","_pos_iswater"];
...
_wp setWaypointStatements ["true", format ["_spawn = [group this,%1,%2] spawn btc_fnc_civ_traffic_add_WP;",_area,_pos_iswater]];
