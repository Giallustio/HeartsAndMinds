...
player createDiaryRecord [_MainCategory, [localize "STR_A3_FM_Welcome4",
    ("<img image='\A3\ui_f\data\igui\cfg\simpleTasks\types\download_ca.paa' width='20' height='20'/> Version " + str(btc_version) + "0.0 <img image='\A3\ui_f\data\igui\cfg\simpleTasks\types\download_ca.paa' width='20' height='20'/>")
    ]
];
