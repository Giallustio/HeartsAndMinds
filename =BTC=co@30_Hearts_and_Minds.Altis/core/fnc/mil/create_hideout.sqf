params [["_city", objNull]];

if (_city isEqualTo objNull) then {
...
private _pos = [_random_pos, 0, 100, 2, false] call btc_fnc_findsafepos;

if (_pos isEqualTo []) then {_pos = getPos _city;};

_city setPos _pos;
private _id = _city getVariable ["id", 0];
