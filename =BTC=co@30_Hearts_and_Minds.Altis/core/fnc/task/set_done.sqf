...
switch _this do
{
	...
	case 1 : {
		...
		[player,["task_2"],["Size the last positions held by the enemies","Size the last enemies positions","Size the last enemies positions"],objNull,true,1,true,"kill",true] call BIS_fnc_taskCreate;
	};
	case 3 : {
		private "_task";
