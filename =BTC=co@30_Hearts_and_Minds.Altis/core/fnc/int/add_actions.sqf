...
{ //Actions attachted to AI
    ...
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
    _action = ["Give_banana", "Give banana", "\A3\ui_f\data\igui\cfg\simpleTasks\types\talk_ca.paa", {[player, _target] call btc_fnc_int_giveFood}, {alive _target && {"ACE_Banana" in items player}}] call ace_interact_menu_fnc_createAction;
    [_x, 0, ["ACE_MainActions"], _action] call ace_interact_menu_fnc_addActionToClass;
