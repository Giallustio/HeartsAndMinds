...
if (isNull _unit) then {
    ...
    if (_order isEqualTo 4) then {
        ...
        if (_rep >= 500) then {
            ...
            if (isNil {player getVariable "interpreter"}) exitWith {[name _unit,localize "STR_BTC_HAM_CON_INFO_ASKREP_NOINTER"] call btc_fnc_showSubtitle;}; //I can't understand what is saying
