...
if (
    ...
    _action = [
        "log_tow",
        localize "STR_BTC_HAM_ACTION_VEHINIT_TOW",
        "\z\ace\addons\attach\UI\attach_ca.paa",
        {_target call btc_tow_fnc_ropeCreate;},
        {!isNull btc_tow_vehicleSelected && {btc_tow_vehicleSelected != _target}}
    ] call ace_interact_menu_fnc_createAction;
...
_action = [
    "log_hook",
    localize "STR_BTC_HAM_ACTION_VEHINIT_HOOK",
    "\z\ace\addons\attach\UI\attach_ca.paa",
    {btc_tow_vehicleSelected = _target; (localize "STR_BTC_HAM_TOW_HOOK") call CBA_fnc_notify;},
    {true}
] call ace_interact_menu_fnc_createAction;
[_type, 0, ["ACE_MainActions", "Logistic"], _action] call ace_interact_menu_fnc_addActionToClass;
...
_action = [
    "log_hook",
    localize "STR_BTC_HAM_ACTION_VEHINIT_UHOOK",
