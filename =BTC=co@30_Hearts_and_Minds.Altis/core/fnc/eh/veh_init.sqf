...
switch true do {
    ...
    case (_type isKindOf "UAV_06_base_F") : {
        private _action = ["Fire_leaflets", "fire leaflets","\A3\ui_f\data\igui\cfg\simpleTasks\types\container_ca.paa",{(_this select 0) fire "Bomb_Leaflets"},{(driver vehicle player) isEqualTo player}] call ace_interact_menu_fnc_createAction;
        [_type, 1, ["ACE_SelfActions"], _action, true] call ace_interact_menu_fnc_addActionToClass;
    };
