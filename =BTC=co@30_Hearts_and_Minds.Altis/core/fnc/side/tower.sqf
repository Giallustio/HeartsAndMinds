...
[[_x + (sin(_direction)*5), _y + (cos(_direction)*5), _z], _statics, _direction] call btc_fnc_mil_create_static;
[[_x - (sin(_direction)*5), _y - (cos(_direction)*5), _z], _statics, _direction + 180] call btc_fnc_mil_create_static;
