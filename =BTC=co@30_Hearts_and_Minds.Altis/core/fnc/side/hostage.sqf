...
private ["_useful","_city","_pos","_group","_trigger","_captive"];
...
typeOf (playableUnits select 0) createUnit [_pos, _group, "_captive = this; [this,true] call ACE_captives_fnc_setHandcuffed;"];



waitUntil {sleep 5; (btc_side_aborted || btc_side_failed || !(_captive getVariable ["ace_captives_isHandcuffed", false]) || Alive _captive)};

[_trigger,_units,_group] spawn {
