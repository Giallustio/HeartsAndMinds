...
([_weapons, _pistols] apply {_x select _color}) params ["_weapon", "_pistol"];
...
private _cargos = [
    [],
    [_backpacks select _color, [["ACE_fieldDressing", 25], ["ACE_morphine", 12], ["ACE_epinephrine", 12], ["ACE_bloodIV", 2], ["ACE_bloodIV_250", 2], ["ACE_bloodIV_500", 1], ["SmokeShellGreen", 3, 1], ["SmokeShellPurple", 1, 1]]],
...
if (_isDay) then {
    [
        ...
        [_vests select _color, [["SmokeShellGreen", 2, 1], [_weaponMagazine,7, _weaponCount], ["SmokeShellPurple", 2, 1], ["SmokeShellYellow", 1, 1], [_pistolMagazine, 1, _pistolCount], ["ACE_M84", 1, 1], ["HandGrenade", 3, 1]]],
    ...
    [
        ...
        [_pistol, "", "", "", [_pistolMagazine, _pistolCount], [], ""],
        [_uniforms select _color, _cargo_uniform],
        [_vests select _color, [["SmokeShellGreen", 1, 1], ["B_IR_Grenade", 2, 1], [_weaponMagazines param [1, _weaponMagazine], 7, _weaponCount], ["Chemlight_green", 2, 1], ["Chemlight_blue", 2, 1], ["ACE_HandFlare_Green", 1, 1], ["HandGrenade", 3, 1], ["ACE_M84", 1, 1]]],
        _cargos select _type, _helmets select _color, _hoods select _color, _binocular_array,
        ["ItemMap", "B_UavTerminal", ["ItemRadio", _radio] select (isClass(configFile >> "cfgPatches" >> "task_force_radio")), "ItemCompass", "ItemWatch", _night_visions select _color]
    ]
};
