...
if (btc_debug_log) then {
    [format ["CACHE SPAWNED: ID %1 POS %2", btc_cache_n, btc_cache_pos], __FILE__, [false]] call btc_fnc_debug_message;
};

if (btc_debug) then {
    [format ["Cache spawned in %1", btc_cache_pos], __FILE__, [btc_debug, false]] call btc_fnc_debug_message;
    //Marker
