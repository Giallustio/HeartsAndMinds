...
### Good actions:
Helping the local population by fighting the Oplitas, disarming IED's, heal civilians, remove tag, succed side mission and destroy cache/hideout will rise your reputation.
### Bad actions:
