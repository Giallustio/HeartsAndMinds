...
This mission has a database system. Enemy units, towns, hideouts, cache, objects created or static weapons assembled by players or Zeus, vehicles, tag, players markers on global/camp channel are saved. All admin can save mission progress at any time with his self interaction key.
